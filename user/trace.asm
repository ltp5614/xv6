...
int main(int argc, char *argv[]) {
  ...
  14:	8a058593          	addi	a1,a1,-1888 # 8b0 <malloc+0xf8>
  18:	4509                	li	a0,2
  1a:	6c0000ef          	jal	6da <fprintf>
        exit(1);
  1e:	4505                	li	a0,1
  ...
  46:	8be58593          	addi	a1,a1,-1858 # 900 <malloc+0x148>
  4a:	4509                	li	a0,2
  4c:	68e000ef          	jal	6da <fprintf>
    exit(1);
  50:	4505                	li	a0,1
  52:	282000ef          	jal	2d4 <exit>
        fprintf(2, "trace: failed to enable tracing\n");
  56:	00001597          	auipc	a1,0x1
  5a:	88258593          	addi	a1,a1,-1918 # 8d8 <malloc+0x120>
  5e:	4509                	li	a0,2
  60:	67a000ef          	jal	6da <fprintf>
        exit(1);
  64:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3cc:	55050513          	addi	a0,a0,1360 # 918 <digits>
 3d0:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 662:	2bab8b93          	addi	s7,s7,698 # 918 <digits>
 ...
 6b0:	26490913          	addi	s2,s2,612 # 910 <malloc+0x158>
        for(; *s; s++)
